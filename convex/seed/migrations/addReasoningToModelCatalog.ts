...
type ReasoningConfig = { supportsReasoning: boolean; reasoningRequired: boolean; defaultReasoningEffort?: ReasoningEffort };
const MODEL_REASONING_CONFIG: Record<string, ReasoningConfig> = {
  'openai/gpt-5.2-pro': { supportsReasoning: true, reasoningRequired: true, defaultReasoningEffort: 'medium' },
  'google/gemini-3-pro-preview': { supportsReasoning: true, reasoningRequired: true, defaultReasoningEffort: 'high' },
  'google/gemini-3-flash-preview': { supportsReasoning: true, reasoningRequired: false, defaultReasoningEffort: 'medium' },
  'anthropic/claude-opus-4.5': { supportsReasoning: true, reasoningRequired: false, defaultReasoningEffort: 'medium' },
  'anthropic/claude-haiku-4.5': { supportsReasoning: true, reasoningRequired: false, defaultReasoningEffort: 'medium' },
  'x-ai/grok-4.1-fast': { supportsReasoning: true, reasoningRequired: false, defaultReasoningEffort: 'medium' },
};
