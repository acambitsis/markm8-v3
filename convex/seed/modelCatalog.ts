...
const INITIAL_MODELS: SeedModel[] = [
  ...
  { slug: 'x-ai/grok-4', name: 'Grok 4', provider: 'xAI', capabilities: ['grading', 'synthesis'] },
  ...
  { slug: 'openai/gpt-5.2', name: 'GPT 5.2', provider: 'OpenAI', capabilities: ['grading', 'synthesis'], supportsReasoning: true, reasoningRequired: false, defaultReasoningEffort: 'medium' },
  ...
  { slug: 'anthropic/claude-opus-4.5', name: 'Claude Opus 4.5', provider: 'Anthropic', capabilities: ['grading', 'synthesis'], supportsReasoning: true, reasoningRequired: false, defaultReasoningEffort: 'medium' },
  { slug: 'anthropic/claude-sonnet-4', name: 'Claude Sonnet 4', provider: 'Anthropic', capabilities: ['grading', 'synthesis'], supportsReasoning: true, reasoningRequired: false, defaultReasoningEffort: 'medium' },
  ...
  { slug: 'google/gemini-3-pro-preview', name: 'Gemini 3 Pro Preview', provider: 'Google', capabilities: ['grading', 'synthesis'], supportsReasoning: true, reasoningRequired: true, defaultReasoningEffort: 'high' },
];
